...
const Intro = () => {
    return (
        <div className="introduction">
                ...
                <span className="intro"><WorkOutlinedIcon className="ic" /> &nbsp;&nbsp; ESCALE Solution PVT.LTD</span><br /> 
                ...
                <div className="profilesocial">
                    ...
                    <img src="/images/linked.png" alt=""></img><p>https://www.linkedin.<br/>com/in/ravindra-patel-557053164</p><br/><br/>
